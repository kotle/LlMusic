...
@Generated(hash = 667204681)
public SongInfoTable(Long dbId, String id, Integer source, Integer type,
        String des, String name, Long createTime, Long updateTime,
        Long duration, Long size, String coverFilePath, String coverUrlPath,
        String playFilePath, String playUrlPath, String lrcFilePath,
        String lrcUrlPath, String lrcString) {
    this.dbId = dbId;
    this.id = id;
    this.source = source;
    this.type = type;
